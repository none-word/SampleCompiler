...
/* Idts */
    public R visit(sample.Absyn.Idents p, A arg) { return visitDefault(p, arg); }
    public R visitDefault(sample.Absyn.Idts p, A arg) {
      throw new IllegalArgumentException(this.getClass().getName() + ": " + p);
    }
/* Expr */
...
/* Type */
    ...
    public R visit(sample.Absyn.FuncType p, A arg) { return visitDefault(p, arg); }
