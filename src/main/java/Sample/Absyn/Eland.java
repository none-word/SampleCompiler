...
public class Eland extends Expr {
  public final Expr expr_1, expr_2;
  public Eland(Expr p1, Expr p2) { expr_1 = p1; expr_2 = p2; }

  public <R,A> R accept(Sample.Absyn.Expr.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof Sample.Absyn.Eland) {
      Sample.Absyn.Eland x = (Sample.Absyn.Eland)o;
