...
public class VarTypeAnnotation extends Expr {
  public final String ident_;
  public final TAnnot tannot_;
  public final Expr expr_;
  public VarTypeAnnotation(String p1, TAnnot p2, Expr p3) { ident_ = p1; tannot_ = p2; expr_ = p3; }

  public <R,A> R accept(Sample.Absyn.Expr.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof Sample.Absyn.VarTypeAnnotation) {
      Sample.Absyn.VarTypeAnnotation x = (Sample.Absyn.VarTypeAnnotation)o;
