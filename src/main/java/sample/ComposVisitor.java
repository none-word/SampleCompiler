...
public class ComposVisitor<A> implements
  ...
  sample.Absyn.Idts.Visitor<sample.Absyn.Idts,A>,
...
/* Idts */
    public Idts visit(sample.Absyn.Idents p, A arg)
    {
      ListIdent listident_ = p.listident_;
      return new sample.Absyn.Idents(listident_);
    }
/* Expr */
    public Expr visit(sample.Absyn.Import p, A arg)
    {
      Idts idts_ = p.idts_.accept(this, arg);
      return new sample.Absyn.Import(idts_);
...
/* Type */
    ...
    }    public Type visit(sample.Absyn.FuncType p, A arg)
    {
      FArgs fargs_ = p.fargs_.accept(this, arg);
      Type type_ = p.type_.accept(this, arg);
      return new sample.Absyn.FuncType(fargs_, type_);
    }
/* TypeAl */
