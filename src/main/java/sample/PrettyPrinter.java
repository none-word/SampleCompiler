...
public class PrettyPrinter
{
  ...
  public static String print(sample.Absyn.Idts foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(sample.Absyn.Idts foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  public static String print(sample.Absyn.ListIdent foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(sample.Absyn.ListIdent foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  public static String print(sample.Absyn.TypeAl foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(sample.Absyn.TypeAl foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  private static void pp(sample.Absyn.Idts foo, int _i_)
  {
    if (foo instanceof sample.Absyn.Idents)
    {
       sample.Absyn.Idents _idents = (sample.Absyn.Idents) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_idents.listident_, 0);
       if (_i_ > 0) render(_R_PAREN);
    }
  }

  private static void pp(sample.Absyn.ListIdent foo, int _i_)
  {
  ...
  private static void pp(sample.Absyn.Expr foo, int _i_)
  {
    ...
    else     if (foo instanceof sample.Absyn.GlVarTypeAnnotation)
    {
       sample.Absyn.GlVarTypeAnnotation _glvartypeannotation = (sample.Absyn.GlVarTypeAnnotation) foo;
       if (_i_ > 3) render(_L_PAREN);
       render("global");
       pp(_glvartypeannotation.ident_, 0);
       pp(_glvartypeannotation.tannot_, 0);
       render("=");
       pp(_glvartypeannotation.expr_, 0);
       if (_i_ > 3) render(_R_PAREN);
    }
    ...
    else     if (foo instanceof sample.Absyn.TableDecl)
    {
       sample.Absyn.TableDecl _tabledecl = (sample.Absyn.TableDecl) foo;
       if (_i_ > 2) render(_L_PAREN);
       pp(_tabledecl.dec_, 0);
       render("=");
       render("(");
       pp(_tabledecl.ident_1, 0);
       render(",");
       pp(_tabledecl.ident_2, 0);
       render(")");
       if (_i_ > 2) render(_R_PAREN);
    }
    else     if (foo instanceof sample.Absyn.GlTableDecl)
    {
    ...
    {
       sample.Absyn.TableElementCall _tableelementcall = (sample.Absyn.TableElementCall) foo;
       if (_i_ > 2) render(_L_PAREN);
       pp(_tableelementcall.ident_1, 0);
       render(".");
       pp(_tableelementcall.ident_2, 0);
       if (_i_ > 2) render(_R_PAREN);
    }
    else     if (foo instanceof sample.Absyn.TableElementAssignment)
    {
       sample.Absyn.TableElementAssignment _tableelementassignment = (sample.Absyn.TableElementAssignment) foo;
       if (_i_ > 2) render(_L_PAREN);
       pp(_tableelementassignment.ident_1, 0);
       render(".");
       pp(_tableelementassignment.ident_2, 0);
       render("=");
       pp(_tableelementassignment.expr_, 0);
       if (_i_ > 2) render(_R_PAREN);
    }
  ...
  private static void pp(sample.Absyn.Type foo, int _i_)
  {
    ...
    else     if (foo instanceof sample.Absyn.FuncType)
    {
       sample.Absyn.FuncType _functype = (sample.Absyn.FuncType) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("func");
       render("(");
       pp(_functype.fargs_, 0);
       render("->");
       pp(_functype.type_, 0);
       render(")");
       if (_i_ > 0) render(_R_PAREN);
    }
  }

  private static void pp(sample.Absyn.TypeAl foo, int _i_)
  {
  ...
  private static void sh(sample.Absyn.Idts foo)
  {
    if (foo instanceof sample.Absyn.Idents)
    {
       sample.Absyn.Idents _idents = (sample.Absyn.Idents) foo;
       ...
       render("Idents");
       render("[");
       sh(_idents.listident_);
       render("]");
       render(")");
    }
  }

  private static void sh(sample.Absyn.ListIdent foo)
  {
     for (java.util.Iterator<String> it = foo.iterator(); it.hasNext();)
     {
       sh(it.next());
  ...
  private static void sh(sample.Absyn.Expr foo)
  {
    ...
    if (foo instanceof sample.Absyn.GlVarTypeAnnotation)
    {
       sample.Absyn.GlVarTypeAnnotation _glvartypeannotation = (sample.Absyn.GlVarTypeAnnotation) foo;
       render("(");
       render("GlVarTypeAnnotation");
       sh(_glvartypeannotation.ident_);
       sh(_glvartypeannotation.tannot_);
       sh(_glvartypeannotation.expr_);
       render(")");
    }
    ...
    if (foo instanceof sample.Absyn.TableDecl)
    {
       sample.Absyn.TableDecl _tabledecl = (sample.Absyn.TableDecl) foo;
       render("(");
       render("TableDecl");
       sh(_tabledecl.dec_);
       sh(_tabledecl.ident_1);
       sh(_tabledecl.ident_2);
       render(")");
    }
    if (foo instanceof sample.Absyn.GlTableDecl)
    {
       sample.Absyn.GlTableDecl _gltabledecl = (sample.Absyn.GlTableDecl) foo;
       render("(");
       render("GlTableDecl");
    ...
    if (foo instanceof sample.Absyn.TableElementCall)
    {
       sample.Absyn.TableElementCall _tableelementcall = (sample.Absyn.TableElementCall) foo;
       render("(");
       render("TableElementCall");
       sh(_tableelementcall.ident_1);
       sh(_tableelementcall.ident_2);
       render(")");
    }
    if (foo instanceof sample.Absyn.TableElementAssignment)
    {
       sample.Absyn.TableElementAssignment _tableelementassignment = (sample.Absyn.TableElementAssignment) foo;
       render("(");
       render("TableElementAssignment");
       sh(_tableelementassignment.ident_1);
       sh(_tableelementassignment.ident_2);
       sh(_tableelementassignment.expr_);
       render(")");
    }
  ...
  private static void sh(sample.Absyn.Type foo)
  {
    ...
    if (foo instanceof sample.Absyn.FuncType)
    {
       sample.Absyn.FuncType _functype = (sample.Absyn.FuncType) foo;
       render("(");
       render("FuncType");
  ...
  private static void sh(sample.Absyn.TypeAl foo)
  {
    if (foo instanceof sample.Absyn.TypeAlIdent)
    {
       sample.Absyn.TypeAlIdent _typealident = (sample.Absyn.TypeAlIdent) foo;
